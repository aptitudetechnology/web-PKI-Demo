// modules/signVerify.js
// Sign & Verify Messages Module

export async function signMessage(keyPair, copyToClipboard) {
...
export async function verifyMessage(keyPair, copyToClipboard) {
    ...
    try {
        ...
        // Properly check signature validity
        let isValid = false;
...
// Toggle visibility of the custom public key input for Verify Message section
