...
// The following functions are removed or commented out as per the request.
...
// Removed: toggleEncryptCustomPublicKey()
...
// Removed: toggleVerifyCustomPublicKey()
/*
...
document.addEventListener('DOMContentLoaded', function() {
    waitForOpenPGP().then(() => {
       ...
       // Removed: document.getElementById('signBtnNew').addEventListener('click', signMessage);
        
        // FIXED: Add the missing verify button event listener
       // Removed: document.getElementById('verifyBtn').addEventListener('click', verifyMessage);
       ...
       // Removed: document.getElementById('toggleEncryptPublicKeyBtn').addEventListener('click', toggleEncryptCustomPublicKey);
       // Removed: document.getElementById('toggleVerifyPublicKeyBtn').addEventListener('click', toggleVerifyCustomPublicKey);
